        ...
        <style>
            html, body {
                /*background-color: #fff;*/
                 background-image:url('images/d45.png');
                color: #636b6f;
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    <a href="https://github.com/wilmercity93">GitHub</a>
                    <a href="http://taowilmercity.ml">TAO Wilmercity</a>
                    <a href="https://www.facebook.com/TAOWilmercity">Facebook</a>
                </div>
            </div>
        </div>
    </body>
